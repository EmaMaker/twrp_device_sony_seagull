...
https://github.com/Nihhaar/android_device_xiaomi_mocha/blob/cm-13.0/libmocha/mocha_audio.c
**/
...
/**
THIS PART HAS BEEN TAKEN FROM:
https://github.com/vampirefo/android_device_blu_p6601/blob/master/libmtk_symbols/icu55.c
**/
